...
def load_translations(lang_code: str = 'de') -> Optional[Dict[str, str]]:
    ...
    default_texts = {
        "app_title": "Ömers Solar-Ding oder sooo",
...
if __name__ == '__main__':
    ...
    if german_texts and german_texts.get("app_title") != "Ömers Solar-Ding oder sooo":
    ...
    if non_existent_texts and non_existent_texts.get("app_title") == "Ömers Solar-Ding oder sooo":
